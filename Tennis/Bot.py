...
class Bot:
    ...
    def import_data(self):
        ...
        # be operated on 14 and 15 are the columns that have the ralley 
        # sequences in them

        df = pd.read_csv(
            r"C:\Users\carlo\TrainingsTool\Tennis\Datasets\
                ralleys_only_m_from_2017.csv")
        ...
        for i in range(0, len(test_df)):
            for j in range(0, 2):
                shot_list = self.turn_ralley_into_shot_list(
    ...
    def add_shot(self, current_ralley, score):
        ...
        randomRalleyError = self.RALLEY_ERROR[
            random.randint(0, len(self.RALLEY_ERROR)-1)]
        ...
        # If shot count in that ralley is 1, add a return: Return cant 
    ...
    def turn_ralley_into_shot_list(self, ralley):
        ...
        if r != "nan":
            for i in range(0, len(r)):
                # If the char is the last char in the ralley, its added 
                ...
                # If char of ralley is in serve Direction, its added to 
                # the shot
                ...
                # This gets printed when there is a ralley, that is not
                # covered by those if statements
                else: print("Unknown Ralley was given in " + r 
                            + " of the Dataset")
