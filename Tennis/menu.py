...
class Menu():
    ...
    def draw_cursor(self):
        self.game.draw_text('O', 30, self.cursor_rect.x, self.cursor_rect.y)
...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Main Menu', 40, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 20)
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Made by me', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.blit_screen()